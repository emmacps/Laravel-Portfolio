                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('store.portfolio')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="portfolio_description" id="portfolio_description">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                <div class="col-sm-2">
                                    <input type="submit" value="Save Portfolio Data" class="btn btn-info waves-effect waves-light">
                                </div>
                            </div>
                        </form>
                    </div>
